...
# These lines were loaded from 'lib/BoyosPlace/Schema/Result/User.pm' found in @INC.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ao5EBJ51M0SulEkU+XY7ew


# You can replace this text with custom code or comments, and it will be preserved on regeneration
1;
# End of lines loaded from 'lib/BoyosPlace/Schema/Result/User.pm' 
