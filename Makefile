...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[BoyosPlace]
#     EXE_FILES => [q[script/boyosplace_cgi.pl], q[script/boyosplace_create.pl], q[script/boyosplace_fastcgi.pl], q[script/boyosplace_server.pl], q[script/boyosplace_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[BoyosPlace]
#     NO_META => q[1]
...
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/BoyosPlace.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/boyosplace_cgi.pl \
	script/boyosplace_create.pl \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  ...
	  script/boyosplace_cgi.pl $(INST_MAN1DIR)/boyosplace_cgi.pl.$(MAN1EXT) \
...
EXE_FILES = script/boyosplace_cgi.pl script/boyosplace_create.pl script/boyosplace_fastcgi.pl script/boyosplace_server.pl script/boyosplace_test.pl

pure_all :: $(INST_SCRIPT)/boyosplace_server.pl $(INST_SCRIPT)/boyosplace_create.pl $(INST_SCRIPT)/boyosplace_cgi.pl $(INST_SCRIPT)/boyosplace_test.pl $(INST_SCRIPT)/boyosplace_fastcgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/boyosplace_server.pl $(INST_SCRIPT)/boyosplace_create.pl \
	  $(INST_SCRIPT)/boyosplace_cgi.pl $(INST_SCRIPT)/boyosplace_test.pl \
	  $(INST_SCRIPT)/boyosplace_fastcgi.pl 

$(INST_SCRIPT)/boyosplace_server.pl : script/boyosplace_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/boyosplace_server.pl
	$(CP) script/boyosplace_server.pl $(INST_SCRIPT)/boyosplace_server.pl
	$(FIXIN) $(INST_SCRIPT)/boyosplace_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/boyosplace_server.pl

$(INST_SCRIPT)/boyosplace_create.pl : script/boyosplace_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/boyosplace_create.pl
	$(CP) script/boyosplace_create.pl $(INST_SCRIPT)/boyosplace_create.pl
	$(FIXIN) $(INST_SCRIPT)/boyosplace_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/boyosplace_create.pl

$(INST_SCRIPT)/boyosplace_cgi.pl : script/boyosplace_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/boyosplace_cgi.pl
	$(CP) script/boyosplace_cgi.pl $(INST_SCRIPT)/boyosplace_cgi.pl
	$(FIXIN) $(INST_SCRIPT)/boyosplace_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/boyosplace_cgi.pl

$(INST_SCRIPT)/boyosplace_test.pl : script/boyosplace_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/boyosplace_test.pl
	$(CP) script/boyosplace_test.pl $(INST_SCRIPT)/boyosplace_test.pl
	$(FIXIN) $(INST_SCRIPT)/boyosplace_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/boyosplace_test.pl

$(INST_SCRIPT)/boyosplace_fastcgi.pl : script/boyosplace_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/boyosplace_fastcgi.pl
	$(CP) script/boyosplace_fastcgi.pl $(INST_SCRIPT)/boyosplace_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)/boyosplace_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/boyosplace_fastcgi.pl
...
catalyst_par :: all
	$(NOECHO) $(PERL) -Ilib -Minc::Module::Install -MModule::Install::Catalyst -e"Catalyst::Module::Install::_catalyst_par( '', 'BoyosPlace', { CLASSES => [], PAROPTS =>  {}, ENGINE => 'CGI', SCRIPT => '', USAGE => q## } )"
